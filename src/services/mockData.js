...
export const INITIAL_MOCK_DATA = {
  ...
  tasks: [
    ...
    {
      id: "TSK-002",
      title: "Fire Protection Pipe Routing Floor 12-16",
      projectId: "PRJ-101",
      project: "Skyline Heights",
      assignee: "Arun Mehra",
      priority: "Medium",
    ...
    {
      id: "TSK-003",
      title: "Glazed Facade Safety Certification",
      projectId: "PRJ-103",
      project: "Metro Commercial Complex",
    ...
    {
      id: "TSK-004",
      title: "Boundary Piling & Retaining Wall Pour",
      projectId: "PRJ-104",
      project: "Riverside Villas & Club",
    ...
    {
      id: "TSK-005",
      title: "Solar Grid Wiring Interconnect",
      projectId: "PRJ-102",
      project: "Green Valley Residency",
