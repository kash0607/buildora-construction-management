...
export const INITIAL_MOCK_DATA = {
  ...
  projects: [
    {
      ...
      committedCost: 35000000, // ₹3.5 Cr
      actualCost: 124000000, // ₹12.4 Cr
      startDate: "2025-04-01",
      deadline: "2027-03-31",
      status: "Active", // Planning, Active, On Hold, Completed, Delayed, Archived
  ...
  milestones: [
    {
      ...
      status: "In Progress",
      description: "Cast in-situ RCC floor plate for 18th floor Tower A.",
    ...
    },
    {
      ...
      progress: 45,
      responsible: "Siddharth Rao",
      status: "In Progress",
      description: "Complete chemical crystalline waterproofing on perimeter earth retaining walls.",
      relatedTaskIds: ["TSK-401", "TSK-402"]
    },
    {
      id: "MLS-03",
      projectId: "PRJ-103",
      title: "HVAC Central Chiller Plant Testing & Commissioning",
      ...
      status: "Upcoming",
      description: "Integrated load testing for 1200 TR dual screw centrifugal chillers.",
      relatedTaskIds: ["TSK-303"]
    },
    {
      id: "MLS-04",
      projectId: "PRJ-102",
      title: "Substructure & Cluster B Piling Sign-off",
      ...
      status: "Completed",
      description: "Geotechnical pile load certification approved by structural auditor.",
      relatedTaskIds: ["TSK-201"]
    },
    {
      id: "MLS-05",
      projectId: "PRJ-105",
      title: "Server Room Environmental & Power Pre-requisites",
      project: "Horizon Tech Park - Tower C",
      dueDate: "2026-09-04",
      dateFormatted: "04 Sep 2026",
      progress: 25,
      responsible: "Rahul Sharma",
      status: "Delayed",
      description: "Custom chiller delivery cleared through customs port and mounted.",
      relatedTaskIds: ["TSK-502"]
    },
    {
      id: "MLS-06",
      projectId: "PRJ-106",
      title: "Villa Estate Municipal Occupancy Handover",
      project: "Palm Grove Estates",
      dueDate: "2026-06-30",
      dateFormatted: "30 Jun 2026",
      progress: 100,
      responsible: "Kashish Patel",
      status: "Completed",
      description: "Complete handover of 32 villas with statutory clearances.",
      relatedTaskIds: ["TSK-601"]
    }
  ],
  ...
  tasks: [
    {
      id: "TSK-101",
      title: "18th Floor Slab Rebar & Shuttering",
      description: "Binding Fe 500D TMT rebars and erecting steel formwork staging for Tower A 18th floor slab.",
      projectId: "PRJ-101",
      project: "Skyline Heights",
    ...
    {
      id: "TSK-102",
      title: "Tower A - 18th Floor Concrete Pouring",
      description: "Pouring 45m³ M40 grade RMC for floor slab and edge beams using mobile boom placer.",
      projectId: "PRJ-101",
      project: "Skyline Heights",
      assignee: "Sanjay Verma",
      priority: "Critical",
    ...
    {
      id: "TSK-103",
      title: "Fire Protection Pipe Routing (Floors 12-16)",
      description: "Pressure testing and anchoring 150mm heavy-duty MS sprinkler risers in fire shafts.",
      projectId: "PRJ-101",
      project: "Skyline Heights",
      assignee: "Arun Mehra",
      priority: "High",
    ...
    {
      id: "TSK-104",
      title: "Tower Crane 2 Hydraulic Pressure Overhaul",
      description: "Repair hydraulic valve fluctuation and calibrate load cell limiter before lifting 19th floor steel columns.",
      projectId: "PRJ-101",
      project: "Skyline Heights",
      assignee: "Arun Mehra",
      priority: "Critical",
    ...
    {
      id: "TSK-105",
      title: "Passenger Lift Core Shuttering (Tower B)",
      description: "Climbing formwork erection for high-speed traction elevator shaft walls from Floor 14 to 17.",
      projectId: "PRJ-101",
      project: "Skyline Heights",
      assignee: "Sanjay Verma",
      priority: "Medium",
    ...
    {
      id: "TSK-106",
      title: "18th Floor Slab Post-Pour Curing & Cube Strength QA",
      description: "Structural laboratory compression test on 7-day concrete test cubes and curing compliance sign-off.",
      projectId: "PRJ-101",
      project: "Skyline Heights",
      assignee: "Sanjay Verma",
      priority: "High",
    ...
    {
      id: "TSK-201",
      title: "Villa Cluster B Substructure Piling Sign-off",
      description: "End-bearing pile static load testing and structural engineer non-destructive sonic testing.",
      projectId: "PRJ-102",
      project: "Green Valley Residency",
    ...
    {
      id: "TSK-202",
      title: "Solar Grid Conduit Interconnect (Villas 1-12)",
      description: "Sub-surface trenching and armored cable pull linking rooftop PV micro-inverters to main distribution kiosk.",
      projectId: "PRJ-102",
      project: "Green Valley Residency",
      assignee: "Ramesh Naik",
      priority: "Medium",
    ...
    {
      id: "TSK-203",
      title: "Stormwater Drainage Regrading near Villa 24",
      description: "Rectify culvert slope gradient conflict identified between architectural layout and landscape survey.",
      projectId: "PRJ-102",
      project: "Green Valley Residency",
    ...
    {
      id: "TSK-204",
      title: "AAC Block Masonry for Cluster C Ground Floor",
      description: "Laying 200mm Autoclaved Aerated Concrete blocks with polymer thin-bed adhesive mortar.",
      projectId: "PRJ-102",
      project: "Green Valley Residency",
      assignee: "Ramesh Naik",
      priority: "Medium",
    ...
    {
      id: "TSK-301",
      title: "LEED Platinum Curtain Wall Glazing Installation",
      description: "Mounting double-glazed unitized glass panels on north atrium facade with acoustic gaskets.",
      projectId: "PRJ-103",
      project: "Metro Commercial Complex",
    ...
    {
      id: "TSK-302",
      title: "Facade Wind Tunnel & Safety Certification",
      description: "On-site mock-up water penetration and structural wind load certification by Façade India Lab.",
      projectId: "PRJ-103",
      project: "Metro Commercial Complex",
      assignee: "Deepak Joshi",
      priority: "Critical",
    ...
    {
      id: "TSK-303",
      title: "Central Chiller Plant Pressure & Leakage Testing",
      description: "Hydrostatic pressure testing of condenser water piping loop at 1.5x operating bar rating.",
      projectId: "PRJ-103",
      project: "Metro Commercial Complex",
      assignee: "Arun Mehra",
      priority: "High",
    ...
    {
      id: "TSK-304",
      title: "Basement 2 High-Voltage Transformer Energization",
      description: "22kV oil-cooled substation dry testing, relay calibration, and utility grid feeder synchronizing.",
      projectId: "PRJ-103",
      project: "Metro Commercial Complex",
    ...
    {
      id: "TSK-401",
      title: "Boundary Piling & Sub-grade Soil Stabilization",
      description: "Drilling 600mm secant piles along coastal boundary and cement grouting weak marine soil pockets.",
      projectId: "PRJ-104",
      project: "Riverside Villas & Club",
    ...
    {
      id: "TSK-402",
      title: "Clubhouse Basement Waterproofing & Retaining Wall",
      description: "Multi-layer HDPE membrane waterproofing application backed by reinforced concrete counterfort retaining wall.",
      projectId: "PRJ-104",
      project: "Riverside Villas & Club",
      assignee: "Siddharth Rao",
      priority: "High",
    ...
    {
      id: "TSK-403",
      title: "Clubhouse Olympic Pool Excavation & Shoring",
      description: "Bulk rock excavation and soldier pile shoring installation for 50m infinity swimming pool.",
      projectId: "PRJ-104",
      project: "Riverside Villas & Club",
      assignee: "Siddharth Rao",
      priority: "Medium",
    ...
    {
      id: "TSK-501",
      title: "Basement Floor 3 Raft Foundation Rebar Laying",
      description: "Installation of 220 MT heavy rebar cage and earthing mesh for IT Tower C basement raft.",
      projectId: "PRJ-105",
      project: "Horizon Tech Park - Tower C",
    ...
    {
      id: "TSK-502",
      title: "Server Room HVAC Chiller Compressor Delivery & Mounting",
      description: "Custom precision air conditioning chiller compressor awaiting customs clearance at Nhava Sheva port.",
      projectId: "PRJ-105",
      project: "Horizon Tech Park - Tower C",
      assignee: "Rahul Sharma",
      priority: "Critical",
    ...
    {
      id: "TSK-503",
      title: "Structural Steel Grid Erection - Tower C Atrium",
      description: "Erecting 18-meter hollow box steel portal frames for central sky-lit tech park lobby.",
      projectId: "PRJ-105",
      project: "Horizon Tech Park - Tower C",
      assignee: "Rahul Sharma",
      priority: "High",
    ...
    {
      id: "TSK-601",
      title: "Final Municipal Occupancy Certificate & Handover",
      description: "Joint site inspection with town planning authorities and issuance of possession certificates to 32 villa owners.",
      projectId: "PRJ-106",
      project: "Palm Grove Estates",
  ...
  issuesList: [
    {
      id: "ISS-101",
      title: "Secondary Rebar delivery delayed by 48 hours",
      projectId: "PRJ-101",
      project: "Skyline Heights",
      priority: "Medium",
      status: "Open",
      assignee: "Sanjay Verma",
      date: "01 Sep 2026",
      description: "Truck transit issue on Pune-Mumbai highway delayed batch delivery."
    },
    {
      id: "ISS-102",
      title: "Tower Crane 2 hydraulic pressure fluctuation",
      projectId: "PRJ-101",
      project: "Skyline Heights",
      priority: "High",
      status: "In Progress",
      assignee: "Arun Mehra",
      date: "31 Aug 2026",
      description: "Pressure drops observed under loads above 8 tons; technician requested."
    },
    {
      id: "ISS-201",
      title: "Drainage slope adjustment needed near Villa 24",
      projectId: "PRJ-102",
      project: "Green Valley Residency",
      priority: "Low",
      status: "Open",
      assignee: "Ramesh Naik",
      date: "02 Sep 2026",
      description: "Minor grading discrepancy in landscape plan."
    },
    {
      id: "ISS-501",
      title: "Chiller unit shipping delay from manufacturer (10 days)",
      projectId: "PRJ-105",
      project: "Horizon Tech Park - Tower C",
      priority: "Critical",
      status: "Open",
      assignee: "Rahul Sharma",
      date: "29 Aug 2026",
      description: "Custom overseas compressor shipment delayed at customs port."
    }
  ]
};
